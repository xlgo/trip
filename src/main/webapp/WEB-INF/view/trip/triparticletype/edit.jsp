...
<div class="pageContent">
	<form method="post" action="<c:url value="${modelPath}/saveJSON"/>" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="56">
			<dl>
				<dt>类别名称：</dt>
				<dd><input name="articleTypeName" class="required" type="text" style="width: 240px;" size="35"  value="${model.articleTypeName}" /></dd>
			</dl>
			<dl class="nowrap">
				<dt>类别描述：</dt>
				<dd><textarea name="articleTypeRemark" class="" style="width: 240px;" rows="4" >${model.articleTypeRemark}</textarea></dd>
			</dl>
		</div>
		<div class="formBar">
			<ul>
